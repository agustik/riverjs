    ...
    tools : {
        ...
        _cleanKey : function (key){
            ...
            var keys = {
                ...
                "vindhviðuhraði(m/s)" : "peakwindspeed_ms",
                "rafleiðin(µs/cm)" : "conducting_uS_cm",
                "rafhlada_min" : "battery_min",
                "rakastig(%)" : "humidity_pr",
                "vatnshiti(c)" : "water_temperature_c",
                "rennsli(m3/s)" : "flowrate_m3s",
                "geislun(w/m2)" : "solarpower_wm2",
                "vatnshæð(cmy.s.)" : "waterheight_os_cm",
                "úrkoma(mm/10mínútum)" : "precipitation_mm10min",
                "rennsli(l/s)" : "flowrate_ls",
                "rennsli_m3/s" : "flowrate_m3s",
                "leiðni(µs/cm)" : "conducting_uS_cm",
                "loftþrýstingur(mb)" : "pressure_mb",
                "vindhraði(m/s)" : "windspeed_ms",
                "rennsli(m3/s)w1" : "flowrate_m3s_w1",
                "vindátt()" : "winddirection_deg",
                "vatnshæð(my.s.)" : "waterheight_os_cm",
                "vatnshæð" : "waterheight_cm",
                "vanshæð(cm)" : "waterheight_cm",
                "rafleiðni(µs/cm)" : "conducting_uS_cm",
                "raflleiðni(µs/cm)" : "conducting_uS_cm",
                "rakastif(%)" : "humidity_pr",
                "rafleiðni(us/cm)" : "conducting_uS_cm",
                "uppsöfnuðúrkoma(mm)" : "cumulative_precipitation",
                "vindhraði(m(s)" : "windspeed_ms",
                "úrkomasíðustu10mín(mm)" : "precipitation_mm10min",
                "uppsöfnuðúrkoma(mm)" : "cumulative_precipitation",
